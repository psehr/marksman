            ...
            <div className="flex flex-col md:flex-row w-full h-1/5 place-content-evenly items-center space-y-4 md:space-y-0 md:space-x-4">
              <div className="relative flex flex-row  w-full h-full md:w-2/3 bg-slate-700 rounded-xl shadow-lg">
                ...
                <div className="relative flex flex-row place-content-center items-center w-2/3 h-full z-0">
                  <div className="flex flex-col space-y-2 w-full mx-4 p-2 px-4 rounded-xl place-content-center items-center">
              ...
              <div className="flex flex-row md:flex-col w-full h-fit md:w-1/3 rounded-xl">
                <div className="flex flex-row md:flex-col w-full h-fit bg-slate-700 p-4 px-4 rounded-xl place-content-evenly shadow-lg space-x-2 md:space-x-0 md:space-y-4">
                ...
                <div className="flex flex-row md:flex-col w-full h-fit bg-slate-700 p-4 px-4 rounded-xl place-content-evenly shadow-lg space-x-2 md:space-x-0 md:space-y-4"></div>
              </div>
            </div>

  ...
  return (
    <div className="flex flex-col w-full h-full space-y-2 items-center place-content-start overflow-y-scroll md:place-content-between">
      ...
      <div className="flex flex-col md:flex-row h-4/5 md:h-3/4 w-full space-y-2 md:space-y-0 md:space-x-4">
        <div className="flex flex-col md:rounded-lg bg-slate-800 w-full md:w-3/4 h-2/3 md:h-full p-4 space-y-4 overflow-y-scroll ">
          <form
            action=""
            onSubmit={(e) => {
              handleSearch(e);
        ...
        <div className="flex flex-col md:rounded-lg bg-slate-800 w-full md:w-1/4 h-1/3 md:h-full p-4 place-content-start items-center">
          {selectedBeatmapset ? (
      ...
      <div className="flex flex-row md:rounded-lg bg-slate-800 w-full h-32 md:h-16 p-4 items-center place-content-center md:place-content-between flex-wrap space-y-2 md:space-y-0">
